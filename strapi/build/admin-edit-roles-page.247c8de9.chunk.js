(self.webpackChunkstrapi=self.webpackChunkstrapi||[]).push([[2544],{4644:(K,L,o)=>{"use strict";o.d(L,{V:()=>R});var e=o(90289),C=o(40464);const R=(v={},O={})=>{const{id:P,...A}=v,{get:y}=(0,e.kY)();if(!P&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:S,error:W,isError:a,isLoading:Z,refetch:m}=(0,C.useQuery)(["roles",P,"permissions",A],async()=>{const{data:{data:M}}=await y(`/admin/roles/${P}/permissions`,{params:A});return M},O);return{permissions:S,error:W,isError:a,isLoading:Z,refetch:m}}},51754:(K,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(27279),C=o(90289),R=o(61020),v=o(40464);const O=(P={},A={})=>{const{id:y="",...S}=P,{get:W}=(0,C.kY)(),{locale:a}=(0,R.Z)(),Z=(0,C.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",y,S],async()=>{const{data:w}=await W(`/admin/roles/${y??""}`,{params:S});return w},A);return{roles:e.useMemo(()=>{let w=[];return y&&m?w=[m.data]:Array.isArray(m?.data)&&(w=m.data),[...w].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,y,Z]),error:M,isError:F,isLoading:g,refetch:b}}},25545:(K,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(27279),C=o(73354),R=o(27875),v=o(10701),O=o(48102),P=o(74758),A=o(93415),y=o(32370),S=o(23298),W=o(74577),a=o(12881),Z=o(39708),m=o(90289),M=o(76827),F=o(84260),g=o(71563),b=o(10124),G=o.n(b),w=o(61020),oe=o(49402),ee=o(51447),E=o(37652),pe=o(4644),Q=o(36364),H=o(442),te=o(90065),Ce=o(47853);const xe=Ce.Ry().shape({name:Ce.Z_().required(m.I0.required),description:Ce.Z_().required(m.I0.required)}),ie=E.ZP.div`
...
`,Z=({children:m,disabled:M=!1,error:F,expanded:g=!1,hasErrorMessage:b=!0,id:G,onToggle:w,toggle:oe,size:ee="M",variant:E="primary",shadow:pe})=>{const Q=(0,O.M)(G),H=C.useMemo(()=>({expanded:g,onToggle:w,toggle:oe,id:Q,size:ee,variant:E,disabled:M}),[M,g,Q,w,ee,oe,E]);return(0,e.jsxs)(v.S.Provider,{value:H,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:M,"aria-disabled":M,expanded:g,hasRadius:!0,variant:E,error:F,shadow:pe,children:m}),F&&b&&(0,e.jsx)(y.x,{paddingTop:1,children:(0,e.jsx)(P.Z,{variant:"pi",textColor:"danger600",children:F})})]})}},34642:(K,L,o)=>{"use strict";o.d(L,{v:()=>v});var e=o(74081),C=o(39267),R=o(93415);const v=({children:O,...P})=>{const{expanded:A,id:y}=(0,C.A)();if(!A)return null;const S=`accordion-content-${y}`,W=`accordion-label-${y}`,a=`accordion-desc-${y}`;return(0,e.jsx)(R.x,{role:"region",id:S,"aria-labelledby":W,"aria-describedby":a,...P,children:O})}},39267:(K,L,o)=>{"use strict";o.d(L,{A:()=>R,S:()=>C});var e=o(27279);const C=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),R=()=>(0,e.useContext)(C)},24920:(K,L,o)=>{"use strict";o.d(L,{B:()=>m});var e=o(74081),C=o(10411),R=o(37652),v=o(45322),O=o(39267);const P=({expanded:M,disabled:F,variant:g})=>{let b="neutral100";return M?b="primary100":F?b="neutral150":g==="primary"&&(b="neutral0"),b};var A=o(1782),y=o(50703),S=o(10701),W=o(32370);const a=(0,R.ZP)(A.A)`
  text-align: left;
